...
class Arbigent < Formula
  ...
  homepage ""
  url "https://github.com/takahirom/arbigent/releases/download/0.72.0/arbigent-0.72.0.tar.gz"
  sha256 "e3a7900a1605b44fb422fbb93c80453ddfd522df65a7cf5c379801092b827e6f"
  license "Apache-2.0"
