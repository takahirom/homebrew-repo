...
class Arbigent < Formula
  ...
  homepage ""
  url "https://github.com/takahirom/arbigent/releases/download/0.75.0/arbigent-0.75.0.tar.gz"
  sha256 "242ec524f9378952a3314ea9c87a16ec29fd3b72811d628754cf9f79577166e3"
  license "Apache-2.0"
