...
class Arbigent < Formula
  ...
  homepage ""
  url "https://github.com/takahirom/arbigent/releases/download/0.54.0/arbigent-0.54.0.tar.gz"
  sha256 "d5a03f09457d339b3242b28293b42828c4eb11ff11aa6cbbedd1b1163796f266"
  license "Apache-2.0"
