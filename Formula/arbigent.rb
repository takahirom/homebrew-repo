...
class Arbigent < Formula
  ...
  homepage ""
  url "https://github.com/takahirom/arbigent/releases/download/0.22.0/arbigent-0.22.0.tar.gz"
  sha256 "0e49672a2e847a21d405b8aa77969dd283014dcc7175d8cc468675a8567592d0"
  license "Apache-2.0"
